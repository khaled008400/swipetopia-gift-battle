...
const VideoActions = ({ likes, comments, shares, isLiked, onLike, videoId = "1" }: VideoActionsProps) => {
  ...
  return (
    <div className="flex flex-col space-y-5 ml-4">
      <button className="flex flex-col items-center" onClick={onLike}>
        <div className={`w-10 h-10 rounded-full ${isLiked ? 'bg-red-500/80' : 'bg-black/50'} flex items-center justify-center cursor-pointer transition-colors duration-200 hover:bg-opacity-80`}>

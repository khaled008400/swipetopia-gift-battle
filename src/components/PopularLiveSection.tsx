...
const PopularLiveSection = ({
  creators
}: PopularLiveSectionProps) => {
  return <div className="absolute top-4 left-0 right-0 px-4 z-20">
      <div className="flex items-center mb-2">
        
        
      </div>
      <div className="flex overflow-x-auto no-scrollbar space-x-3 py-1">
        {creators.map(creator => <div key={creator.id} className="flex flex-col items-center">
